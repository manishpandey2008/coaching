...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
              <a class="navbar-brand logo-custom" href="#"><img src="{{asset('assets/img/km4.png')}}" style="width: 200px;height: 60px;"></a>
 ...
 <div class="container">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        ...
                        <li>
                           ...
                           <h1 >START PREPARATION WITH </h1>
                            <a  href="{{route('getLogin')}}" class="btn btn-info btn-lg" >
                               LOGIN
                            </a>
                        ...
                        <li>
                            <h3>Delivering Quality Education</h3>
                           <h1 >KASHYAP MATHEMATICS</h1>
                             <a  href="{{route('getLogin')}}" class="btn btn-primary btn-lg">
                               LOGIN 
                            </a>
                        </li>
                        <!-- End Slider 02 -->
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i><a href="#features-sec"> WELCOME TO THE EDU-CENTER</a> <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="{{asset('assets/img/faculty/1.jpg')}}"  class="img-rounded" />
                 ...
                 <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                     <img src="{{asset('assets/img/faculty/2.jpg')}}"  class="img-rounded" />
                   <h3 >JANE DEO ALEX</h3>
                 <hr />
               ...
               <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                     <div class="faculty-div">
                     <img src="{{asset('assets/img/faculty/3.jpg')}}" class="img-rounded" />
                   <h3 >RUBY DECORSA</h3>
                 <hr />
    ...
    <!-- FACULTY SECTION END-->
      <div id="course-sec" class="container set-pad">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6 " data-scroll-reveal="enter from the bottom after 0.4s" >
                 <img src="{{asset('assets/img/building.jpg')}}" class="img-thumbnail" />
           </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                     ...
                     <a href="#"> <img src="{{asset('assets/img/Social/google-plus.png')}}" alt="" /></a>
                     <a href="#"> <img src="{{asset('assets/img/Social/twitter.png')}}" alt="" /></a>
                    </div>
                    </div>
